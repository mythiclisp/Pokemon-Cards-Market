        ...
        <footer className="text-center lg:text-left bg-gray-100 text-gray-600">
            ...
            <div className="mx-6 py-10 text-center md:text-left">
                ...
                <div className="">
                    ...
                    Pokemon Cards Market
                    </h6>
                    <p>
                    Best place to buy all the elite pokemon cards
                    </p>
                </div>
                <div className="">
                    ...
                    <p className="mb-4">
                    <a
                    href="https://www.privacypolicies.com/live/9a281d24-10da-4746-b187-7e304ffab9d4"
                    className="text-gray-600"
                    >Privacy Policy</a>
                    </p>
                    <p className="mb-4">
                    <a
                    href="https://www.iubenda.com/terms-and-conditions/66571958"
                    className="text-gray-600"
                    >Terms and Conditions</a>
                    </p>
                    <p className="mb-4">
                    <a href="#!" className="text-gray-600">Cookies</a>
                    </p>
                    <p>
                ...
                <div className="">
                    ...
                    <p className="mb-4">
                    <a href="/cards" className="text-gray-600">Cards</a>
                    </p>
                    <p className="mb-4">
                    <a href="/about" className="text-gray-600">About</a>
                    </p>
                    <p className="mb-4">
                    <a href="/orders" className="text-gray-600">Orders</a>
                    </p>
                    <p>
                    <a href="/cart" className="text-gray-600">Shopping Cart</a>
                    </p>
                </div>
                <div className="">
                    <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
                    ...
                    pokemoncardsmarketcorp@gmail.com
                    </p>
                </div>
                </div>
            </div>

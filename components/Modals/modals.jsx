...
const Modals = () => {
    ...
    return (
        <React.Fragment>
            {/* //Sign Up Modal */}
            <div id="modal-test" className="modal rounded-3xl h-auto max-h-full w-64 p-16">
            <h4>Sign up</h4><br />
                    <form id="signup-form" onSubmit={handleSubmit}>
                        ...
                        <div className="input-field">
                            <input type="file" id='post-image' placeholder='choose' className='form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none' accept='image/x-png,image/gif,image/jpeg'/>
                        </div>
                        <div className="input-field">
            ...
            <div id="modal-buy" className="modal">
                <div className="modal-content">
                    ...
                    <form id='checkout-form' onSubmit={handleSubmit}>
                        ...
                        <div className="input-field">
                            <input type="text" id='card-number' style={{width: '68%'}}/>
                            <label htmlFor="card-number">Card Number</label>
                            <input type="text" id='cvv-number' style={{width: '28%', float: 'right'}}/>
                            <label htmlFor="cvv-number" style={{marginLeft: '74%'}}>CVV</label>
                        </div>
                        <div className="input-field">
                            <input type="text" id='exp-month' style={{width: '48%'}}/>
                            <label htmlFor="exp-month">Expiration Month</label>
                            <input type="text" id='exp-year' style={{width: '48%', float: 'right'}}/>
                            <label style={{marginLeft: '54%'}} htmlFor="exp-year">Expiration Year</label>
                        </div>
                        <button type='submit' className='btn red'>Buy</button>
                    </form>
                </div>
            </div>
        </React.Fragment>
